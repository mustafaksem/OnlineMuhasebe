    ...
    public sealed class AppDbContext : IdentityDbContext<AppUser, AppRole, string>
    {
        ...
        public override Task<int> SaveChangesAsync(CancellationToken cancellationToken = default)
        {
            ...
            foreach (var entry in entries)
            {
                ...
                {
                    entry.Property(p=>p.UpdateTime).CurrentValue=DateTime.Now;
                }
            }
        ...
        public class AppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
        {
            ...
            public AppDbContext CreateDbContext(string[] args)
            {
                ...
                var connectionString = "Data Source=DESKTOP-LQOAMHU\\SQLEXPRESS;Initial Catalog=MuhasebeMasterDb;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False";
