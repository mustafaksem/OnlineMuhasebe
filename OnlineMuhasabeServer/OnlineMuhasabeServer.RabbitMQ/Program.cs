...
namespace OnlineMuhasabeServer.RabbitMQ;
...
internal class Program
{
    ...
    public static void CreateUCAFExcel(ReportDto reportDto)
    {
        ...
        using (var workbook = new XLWorkbook())
        {
            ...
            string filePath = $"C:/Users/mustafa/Desktop/Yazılım/projeler/OnlineMuhasebe/OnlineMuhasebe-Client/src/assets/reports/{fileName}";
